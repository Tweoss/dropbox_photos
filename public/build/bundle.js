...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", img_class_value = "" + ((/*$store*/ ctx[6].event_index == /*event_index*/ ctx[1] && /*$store*/ ctx[6].entry_index == /*entry_index*/ ctx[2]
    			? 'selected'
    			: '') + " " + /*calculated_dimensions*/ ctx[4].scale_class + " svelte-12566eq"));

    			set_style(img, "top", /*calculated_dimensions*/ ctx[4].top + "%");
    			set_style(img, "left", /*calculated_dimensions*/ ctx[4].left + "%");
    			add_location(img, file$4, 87, 4, 2725);
    			attr_dev(div, "class", "container svelte-12566eq");
    			add_location(div, file$4, 86, 0, 2697);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(img, "load", /*load_handler*/ ctx[10], { once: true }, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$store, event_index, entry_index, calculated_dimensions*/ 86 && img_class_value !== (img_class_value = "" + ((/*$store*/ ctx[6].event_index == /*event_index*/ ctx[1] && /*$store*/ ctx[6].entry_index == /*entry_index*/ ctx[2]
    			? 'selected'
    			: '') + " " + /*calculated_dimensions*/ ctx[4].scale_class + " svelte-12566eq"))) {
    				attr_dev(img, "class", img_class_value);
    			}

    			if (dirty & /*calculated_dimensions*/ 16) {
    				set_style(img, "top", /*calculated_dimensions*/ ctx[4].top + "%");
    			}
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const onChangeVisibility = (entries, _observer) => {
    		if (entries[0].isIntersecting) {
    			...
    			: image.loadThumbnail(ACCESS_TOKEN, "w256h256").then(data => {
    					...
    					$$invalidate(3, image_data = initial_image);
    					$$invalidate(4, calculated_dimensions = calculate_dimensions());
    				});
    		} else {
    			thumbnail
    			? 0
    	...
    	store.subscribe(store => {
    		if (store.event_index == event_index && store.entry_index == entry_index) {
    	...
    	$$self.$$set = $$props => {
    		if ('ACCESS_TOKEN' in $$props) $$invalidate(7, ACCESS_TOKEN = $$props.ACCESS_TOKEN);
    		if ('image_entry' in $$props) $$invalidate(0, image_entry = $$props.image_entry);
    		if ('default_data' in $$props) $$invalidate(8, default_data = $$props.default_data);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('event_index' in $$props) $$invalidate(1, event_index = $$props.event_index);
    		if ('entry_index' in $$props) $$invalidate(2, entry_index = $$props.entry_index);
    		if ('isInView' in $$props) isInView = $$props.isInView;
    		...
    		if ('calculated_dimensions' in $$props) $$invalidate(4, calculated_dimensions = $$props.calculated_dimensions);
    ...
    class Image extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*ACCESS_TOKEN*/ ctx[7] === undefined && !('ACCESS_TOKEN' in props)) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(video, "class", video_class_value = "" + ((/*selected*/ ctx[4] ? 'selected' : '') + " " + /*calculated_dimensions*/ ctx[6].scale_class + " " + (/*maximized*/ ctx[5] ? 'maximized' : '') + " svelte-e191tk"));
    			...
    			add_location(video, file$3, 119, 4, 3938);
    			...
    			attr_dev(i, "class", i_class_value = "" + ((/*element*/ ctx[7] ? 'fa fa-play-circle-o ' : '') + " " + (/*maximized*/ ctx[5] ? "hidden" : "") + " svelte-e191tk"));
    			add_location(i, file$3, 147, 4, 4984);
    			attr_dev(div, "class", "container svelte-e191tk");
    			add_location(div, file$3, 117, 0, 3860);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*selected, calculated_dimensions, maximized*/ 112 && video_class_value !== (video_class_value = "" + ((/*selected*/ ctx[4] ? 'selected' : '') + " " + /*calculated_dimensions*/ ctx[6].scale_class + " " + (/*maximized*/ ctx[5] ? 'maximized' : '') + " svelte-e191tk"))) {
    			...
    			if (dirty & /*element, maximized*/ 160 && i_class_value !== (i_class_value = "" + ((/*element*/ ctx[7] ? 'fa fa-play-circle-o ' : '') + " " + (/*maximized*/ ctx[5] ? "hidden" : "") + " svelte-e191tk"))) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const focus_handler = () => element.play();
    	const mouseover_handler = () => element.play();
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 73, 12, 2757);
    		},
    		m: function mount(target, anchor) {
    ...
    // (55:8) {#if element.metadata.filetype == FileType.Image}
    function create_if_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(55:8) {#if element.metadata.filetype == FileType.Image}",
    		ctx
    	});
    ...
    // (56:12) {#if element.live_video_metadata}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(56:12) {#if element.live_video_metadata}",
    		ctx
    	});
    ...
    // (54:4) {#each event_contents as element, entry_index}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(54:4) {#each event_contents as element, entry_index}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 51, 4, 1836);
    			attr_dev(div, "class", "svelte-16t62c2");
    			add_location(div, file$2, 50, 0, 1826);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Event extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*ACCESS_TOKEN*/ ctx[0] === undefined && !('ACCESS_TOKEN' in props)) {
    			console_1$1.warn("<Event> was created without expected prop 'ACCESS_TOKEN'");
    		}

    		if (/*event_index*/ ctx[2] === undefined && !('event_index' in props)) {
    			console_1$1.warn("<Event> was created without expected prop 'event_index'");
    		}
    	}
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 21, 4, 2439);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*button_text*/ 2) set_data_dev(t, /*button_text*/ ctx[1]);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window, "click", /*click_handler*/ ctx[3], false, false, false),
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ show_button, button_text, clickHandler });
    	...
    	return [show_button, button_text, clickHandler, click_handler, keydown_handler];
    }
    ...
    // (39:4) {#each events_entries as event, event_index}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(39:4) {#each events_entries as event, event_index}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			p.textContent = "HI";
    			add_location(p, file, 47, 12, 1411);
    			add_location(div, file, 46, 8, 1393);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(46:4) {#if $store.file_info}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file, 32, 4, 969);
    			attr_dev(h1, "class", "svelte-d9gu0h");
    			add_location(h1, file, 36, 4, 1109);
    			attr_dev(main, "class", "svelte-d9gu0h");
    			add_location(main, file, 30, 0, 926);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const keydown_handler = e => store.set(index.handle_keydown(e, get_store_value(store), events_entries));
